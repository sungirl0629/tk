...
export default class cuotidati extends Component {
  ...
  //读取userid
     ...
     let _this=this;
            ...
            let parms="tid="+this.state.tid+"&flag="+this.state.flag+'&userid='+this.state.userid;
  ...
  <View>
    <View style={styles.tou}>
      ...
      <Text style={styles.tous}>错题库答题</Text>
    </View>
