...
componentWillMount(){
  ...
  <View>
    <View style={styles.tou}>
      ...
      <Text style={styles.tous}>目标设定学习</Text>
    </View>
    ...
    <View style={{flexDirection:'row',paddingTop:20}}>
      ...
      <TouchableOpacity activeOpacity={0.1} onPress={this.nexttimu} style={{marginLeft:'45%'}}>
		<Image style={{width:90,height:31,marginLeft:10}} source={require('../images/xia.png')}/>
      </TouchableOpacity>
    </View>
  </View>
    );
