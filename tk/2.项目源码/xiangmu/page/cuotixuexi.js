...
export default class cuotixuexi extends Component {
  ...
  componentWillMount(){ 
            ...
            let _this=this;
            let url="http://www.hilyy.cn/index.php/tiku/Xiangmu/cuotixuexi";
            let parms="kk="+this.state.kk+"&tid="+this.state.tid+"&flag="+this.state.flag+"&userid="+this.state.userid;
  ...
  <View>
    <View style={styles.tou}>
      ...
      <Text style={styles.tous}>错题库学习</Text>
    </View>
