...
export default class suiji extends Component {
  fanhui=()=>{
  ...
  someFlag: true,
    ...
    this.forceUpdate();
            ...
            let _this=this;
            let url="http://www.hilyy.cn/index.php/tiku/Xiangmu/suiji";
            let parms="flag="+this.state.flag+"&sjtkid="+this.state.sjtkid+"&kk="+this.state.kk+"&sjid="+this.state.sjid;
  ...
  <View>
    <View style={styles.tou}>
      ...
      <Text style={styles.tous}>随机答题</Text>
    </View>
