<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/data/home/bxu2713300369/htdocs/application/tiku/view/index/upchengjichaxun.html";i:1501668209;}*/ ?>
<!doctype html>
<html>
        ...
        <div class="tpl-block ">
            ...
            <div class="am-g tpl-amazeui-form">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" action="<?php echo url('Index/do_upchengjichaxun'); ?>" method="post"
                          enctype="multipart/form-data">
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">姓名 / Name</label>
                            <div class="am-u-sm-9">
                                <input type="hidden" name="id" value="<?php echo $list['id']; ?>">
                                <input type="text" id="user-name" name="mid" value="<?php echo $list['mid']; ?>"
                                       placeholder="姓名 / Name">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="pid" value="<?php echo $list['pid']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="answer" value="<?php echo $list['answer']; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" name="pubdate" value="<?php echo $list['pubdate']; ?>"/>
                            </div>
                        </div>
