<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/data/home/bxu2713300369/htdocs/application/tiku/view/index/addtests.html";i:1501809154;}*/ ?>
<html>
<head>
                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" action="<?php echo url('Index/do_addtests'); ?>" method="post" enctype="multipart/form-data">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">标题<span class="tpl-form-line-small-title">Title</span></label>
                                    <div class="am-u-sm-9">
                                        <input name="title" type="text" class="tpl-form-input" id="user-name" placeholder="请输入标题">
								 ...
								 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <option value="0">--请选择--</option>
											...
											<option value="<?php echo $info['id']; ?>"><?php echo $info['id']; ?></option>
											<?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
