<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/data/home/bxu2713300369/htdocs/application/tiku/view/login/index.html";i:1501547304;}*/ ?>
<!doctype html>
<html>
...
<div class="am-g myapp-login">
    <div class="myapp-login-logo-block  tpl-login-max">
        <div class="myapp-login-logo-text">
            <div class="myapp-login-logo-text">
                随身题库后台管理<span></span> <i class="am-icon-skyatlas"></i>
