<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"/data/home/bxu2713300369/htdocs/application/tiku/view/index/uptimu.html";i:1501668655;}*/ ?>
<head>
<!-- 新闻添加 -->
    <meta charset="utf-8">
...
<body>      
                ...
                <div class="tpl-block">
                    ...
                    <div class="am-g">
                        ...
                        <div class="tpl-form-body tpl-form-line">
                            <form class="am-form tpl-form-line-form" action="<?php echo url('Index/do_timu'); ?>" method="post" enctype="multipart/form-data">
								...
								<input type="hidden" name="uid" value="<?php echo $info['id']; ?>"/>
                                    ...
                                    <div class="am-u-sm-9">
                                        <input name="title" value="<?php echo $info['title']; ?>" type="text" class="tpl-form-input" id="user-name" placeholder="请输入题目">
								...
								<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input name="subject_score" value="<?php echo $info['subject_score']; ?>" type="text" class="tpl-form-input" id="user-name" placeholder="请输入题目分数">
                                 ...
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <option value="0">--请选择--</option>
                                            <?php if(is_array($grouplist) || $grouplist instanceof \think\Collection || $grouplist instanceof \think\Paginator): if( count($grouplist)==0 ) : echo "" ;else: foreach($grouplist as $key=>$val): ?>
											<option <?php if($info['id'] == $val['id']): ?>selected="selected"<?php endif; ?> value="<?php echo $val['id']; ?>"><?php echo $val['subname']; ?></option>
								 ...
								 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <option>--请选择题目类型--</option>
											<option <?php if($info['id'] == 1): ?>selected="selected"<?php endif; ?> value="1">单选题</option>
											<option <?php if($info['id'] == 2): ?>selected="selected"<?php endif; ?> value="2">多选题</option>
											<option <?php if($info['id'] == 3): ?>selected="selected"<?php endif; ?> value="3">填空题</option>
											<option <?php if($info['id'] == 4): ?>selected="selected"<?php endif; ?> value="4">解答题</option>
                                        </select>
    ...
    <i class="am-icon-cloud-upload"></i> 添加封面图片</button>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea name="content"  class="" rows="10" id="user-intro" placeholder="请输入题目内容"><?php echo $info['content']; ?></textarea>
                                    </div>
                                </div>
